...
var TwilioRequestSignature = function() {
  ...
  this.evaluate = function(context) {
    ...
    return base64_sha1_sig;
  }
}
// set the Extension Identifier (must be same as the directory name)
TwilioRequestSignature.identifier = "com.twilio.PawExtensions.TwilioRequestSignature";
// give a display name to your Dynamic Value
TwilioRequestSignature.title = "Twilio Request Signature Generator";
// give a display name to your Dynamic Value
TwilioRequestSignature.inputs = [
    InputField("auth_token", "Auth Token", "SecureValue", {persisted: true, placeholder: "Type an Auth Token"}),
];// link to the Dynamic Value documentation
TwilioRequestSignature.help = "https://www.twilio.com/docs/api/security";
// call to register function is required
registerDynamicValueClass(TwilioRequestSignature)
